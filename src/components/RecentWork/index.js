...
import yak from '../../assets/image/shave-the-yak.png';
            ...
            <div class="card-container">
                ...
                <div class="card">
                    <header class="article-header">
                        ...
                        <div>
                            <h2 class="article-title">Shave the Yak</h2>
                            <div class="description">Coding Quiz Game</div>
                        </div>
                    </header>
                    <img src={yak} alt="Weather Application"></img>
                    <div className="author">
                        <div className="profile"></div>
                        <div className="info">
                            <div className="link">
                                <a href="https://evening-reef-89907.herokuapp.com/">View Project</a>       
                            </div>
                        </div>
                    </div>
                    <div class="tags">
